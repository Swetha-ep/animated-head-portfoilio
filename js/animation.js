...
let tlActive = "translatX(5vw) translateY(0)";
let tlhidden = "translatex(-100vw) translateY(-100vh)";

let trActive = "translatX(-5vw) translateY(0)";
let trhidden = "translatex(100vw) translateY(-100vh)";

let blActive = "translatX(10vw) translateY(7vh)";
let blhidden = "translatex(-100vw) translateY(100vh)";

let brActive = "translatX(-5vw) translateY(0)";
...
tlBtn.onclick = function () {
    if (activeCorner === "top-left"){
        ...
        trContent.style.background = trhidden;
        brContent.style.background = brhidden;
        blContent.style.background = blhidden;
        tlContent.style.background = tlActive;
...
trBtn.onclick = function (){
    if (activeCorner === "top-right"){
        ...
        trContent.style.background = trActive;
        brContent.style.background = brhidden;
        blContent.style.background = blhidden;
        tlContent.style.background = tlhidden;
...
blBtn.onclick = function (){
    if (activeCorner === "bottom-left"){
        ...
        trContent.style.background = trhidden;
        brContent.style.background = brhidden;
        blContent.style.background = blActive;
        tlContent.style.background = tlhidden;
...
brBtn.onclick = function (){
    if (activeCorner === "bottom-right"){
        ...
        trContent.style.background = trhidden;
        brContent.style.background = brActive;
        blContent.style.background = blhidden;
        tlContent.style.background = tlhidden;
